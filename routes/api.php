...
use App\Http\Controllers\Api\ColaboradoreController;
...
Route::post('/colaboradores', [App\Http\Controllers\Api\ColaboradoreController::class, 'store']);
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('colaboradores', App\Http\Controllers\Api\ColaboradoreController::class)->except(['store']);
    Route::get('/ambientes/semana', [App\Http\Controllers\Api\AmbienteController::class, 'getOcupacaoSemanal']);
    Route::get('/turmas/turmas-iniciadas', [App\Http\Controllers\Api\TurmaController::class, 'getTurmasIniciadas']);
